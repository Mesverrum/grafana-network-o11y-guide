...
- Install steps a reader can run without another repo ([docs/install-alloy.md](docs/install-alloy.md)) — public GHCR image first; compile is the documented alternative
- Share-time caveats stay on the README (**Read this before you start**) — own stack, SNMP-only first pass, Fleet later, baked image library, no SLA
