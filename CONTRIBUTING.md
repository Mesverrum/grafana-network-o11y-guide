...
- Default install is **Docker Compose + host networking** on a Linux poller ([README](README.md#quickstart)). Host systemd stays under [docs/install-alloy.md](docs/install-alloy.md#optional-run-as-a-host-service). Profile iteration is extract + `compose.override.yaml`, not a new Alloy binary.
